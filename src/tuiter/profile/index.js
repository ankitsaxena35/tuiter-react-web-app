    ...
    return (
        <>
            <div>
                <div className="row">
                    <div className="col-1">
                        <span className=""><i className="fa fa-arrow-left" aria-hidden="true"></i></span>
                    </div>
                    <div className="col-3">
                        <div className="row">
                            <span className=""> <strong className="">{profile.firstName} {profile.lastName}</strong></span>
                        </div>
                        <div className="row">
            ...
            <div className="mt-2">
                ...
                <Link to="/tuiter/edit-profile"><button type="button" className="btn btn-outline-dark float-end">Edit Profile</button></Link>
            </div>
            <div>
                <div className="row">
                    <span className=""> <strong className="">{profile.firstName} {profile.lastName}</strong></span>
                    ...
                    <div className="row mt-2">
                        <div className="col-3">
                            <span className=""> <strong className=""> {profile.followingCount}</strong></span><span className="text-muted"> Following</span>
                        </div>
                        <div className="col-3">
                            <span className=""> <strong className=""> {profile.followersCount} </strong></span><span className="text-muted"> Followers</span>
                        </div>
                    </div>
